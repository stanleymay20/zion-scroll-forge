...
export type NotificationChannel = 'email' | 'push_notification' | 'sms' | 'websocket' | 'in_app' | 'webhook';
export type NotificationPriority = 'low' | 'normal' | 'high' | 'urgent' | 'critical';
export type NotificationStatus = 'pending' | 'queued' | 'sending' | 'sent' | 'delivered' | 'failed' | 'read' | 'cancelled';
...
// Enhanced types for SU-AYAS notification system
export interface DeliveryTrackingResult {
  ...
  readAt?: Date;
  failureReason?: string;
  trackingEvents: DeliveryAttempt[];
}
