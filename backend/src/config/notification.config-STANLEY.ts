...
export const notificationConfig: NotificationServiceConfig = {
  ...
  queue: {
    processingInterval: parseInt(process.env.NOTIFICATION_QUEUE_INTERVAL || '30000', 10), // ms
    batchSize: parseInt(process.env.NOTIFICATION_QUEUE_BATCH_SIZE || '50', 10),
  },
  scheduler: {
    checkInterval: parseInt(process.env.NOTIFICATION_SCHEDULER_INTERVAL || '60000', 10), // ms
  },
};
