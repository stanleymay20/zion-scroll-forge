...
const tables = ['courses', 'course_modules', 'lectures', 'enrollments', 'users', 'assignments', 'submissions', 'scrollgold_transactions', 'scrollbadges', 'prayer_journal_entries', 'devotions', 'study_groups', 'community_posts', 'academic_calendar', 'degree_programs', 'scholarships'];
