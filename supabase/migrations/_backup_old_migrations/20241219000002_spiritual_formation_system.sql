...
CREATE TABLE IF NOT EXISTS public.spiritual_milestones (
    ...
    reward_ScrollGolds INTEGER DEFAULT 0,
    badge_icon TEXT,
    badge_color TEXT,
...
CREATE TABLE IF NOT EXISTS public.spiritual_activities (
    ...
    ScrollGolds_earned INTEGER DEFAULT 0,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
BEGIN
    ...
    LOOP
        ...
        IF milestone_met THEN
            ...
            -- Award ScrollGolds
            IF milestone.reward_ScrollGolds > 0 THEN
                PERFORM earn_ScrollGold(
                    user_uuid,
                    milestone.reward_ScrollGolds,
...
INSERT INTO public.spiritual_milestones (name, description, category, requirements, reward_ScrollGolds, badge_icon, badge_color) VALUES
