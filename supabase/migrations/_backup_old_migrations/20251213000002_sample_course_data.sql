...
INSERT INTO courses (id, title, description, faculty_id, faculty, level, price_cents, rating, students_count, duration, tags, xr_enabled, created_at) VALUES
  ...
  (
    'course-2',
    'Kingdom Economics & ScrollGold Mastery',
    'Learn biblical principles of wealth creation, stewardship, and the revolutionary ScrollGold economy. Understand how to build kingdom businesses and manage resources for maximum kingdom impact.',
    'f2',
    'Kingdom Economics',
    'Intermediate',
    35000, -- 350 SC
    ...
    1923,
    '10 weeks',
    '["economics", "ScrollGold", "business", "stewardship"]',
    false,
    NOW()
  ),
  (
