...
CREATE TABLE IF NOT EXISTS achievements (
  ...
  scrollgold_reward INT DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS user_stats (
  ...
  total_scrollgolds INT DEFAULT 0,
...
DROP POLICY IF EXISTS "Public groups viewable by all" ON study_groups;
...
DROP POLICY IF EXISTS "Members viewable by group members" ON study_group_members;
...
DROP POLICY IF EXISTS "Messages viewable by group members" ON study_group_messages;
...
DROP POLICY IF EXISTS "Members can post messages" ON study_group_messages;
...
DROP POLICY IF EXISTS "Reviews viewable by all" ON course_reviews;
...
GROUP BY u.id, u.email, us.total_xp, us.total_scrollgolds, us.courses_completed, us.current_streak, us.longest_streak
