CREATE OR REPLACE FUNCTION public.issue_certificate(p_user_id uuid, p_cert_type text, p_program_name text, p_entity_id uuid DEFAULT NULL::uuid, p_metadata jsonb DEFAULT '{}'::jsonb)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
...
BEGIN
  ...
  IF NOT v_is_admin THEN
    -- Blocking holds gate everything
    SELECT EXISTS (
