...
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
Write-Host "[OK] Supabase running on http://localhost:54321" -ForegroundColor Green
Write-Host "[OK] Database available at localhost:54322" -ForegroundColor Green
Write-Host "[OK] Studio UI at http://localhost:54323" -ForegroundColor Green
