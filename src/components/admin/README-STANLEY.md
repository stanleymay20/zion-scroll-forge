...
Real-time workflow execution monitoring for Academic Year Automation System.

**Features:**
- Real-time workflow status tracking
- Workflow statistics (total, running, completed, failed)
...
**Usage:**
```tsx
import { WorkflowMonitoringDashboard } from '@/components/admin';
...
**Usage:**
```tsx
import { NotificationCenter } from '@/components/admin';
...
Comprehensive analytics and reporting for academic operations.
...
**Usage:**
```tsx
import { AcademicAnalyticsDashboard } from '@/components/admin';
