/**
 * Send/Receive ScrollGold Interface
 * Handles peer-to-peer transfers and receiving ScrollGold
 */
...
import { ScrollGoldWallet } from '@/types/ScrollGold';

interface SendReceiveInterfaceProps {
  wallet: ScrollGoldWallet;
    ...
    <div className="space-y-6">
      <Tabs defaultValue="send" className="w-full">
        ...
        <TabsContent value="send">
          <Card>
            <CardHeader>
              <CardTitle>Send ScrollGold</CardTitle>
              <CardDescription>
                Transfer ScrollGold to another user
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSend} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Enter the user ID of the person you want to send ScrollGold to
                  </p>
                </div>
        ...
        <TabsContent value="receive">
          <Card>
            <CardHeader>
              <CardTitle>Receive ScrollGold</CardTitle>
              <CardDescription>
                Share your wallet address to receive ScrollGold
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Share this address with others to receive ScrollGold
                </p>
              </div>
              ...
              <Alert>
                <AlertDescription>
                  <h4 className="font-semibold mb-2">How to receive ScrollGold:</h4>
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>The ScrollGold will appear in your balance</li>
                  </ol>
                </AlertDescription>
              </Alert>
            </CardContent>
