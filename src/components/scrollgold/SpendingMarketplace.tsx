 ...
 * Displays items and services that can be purchased with ScrollGold
 */
...
import { SpendingOption } from '@/types/ScrollGold';
...
const SpendingMarketplace: React.FC<SpendingMarketplaceProps> = ({ currentBalance }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>ScrollGold Marketplace</CardTitle>
          <CardDescription>
            Use your ScrollGold to access courses, resources, and support kingdom initiatives
          </CardDescription>
        </CardHeader>
        <CardContent>
          {/* Balance Display */}
