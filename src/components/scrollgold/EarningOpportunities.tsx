 ...
 * Displays ways to earn ScrollGold through various activities
 */
...
import { EarningOpportunity } from '@/types/ScrollGold';
    ...
    const mockOpportunities: EarningOpportunity[] = [
      {
        ...
        description: 'Finish any course with a passing grade to earn ScrollGold rewards',
        rewardAmount: 100,
        category: 'COURSE',
        difficulty: 'MEDIUM',
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Discover ways to earn ScrollGold through learning, community engagement, and spiritual growth
          </CardDescription>
        </CardHeader>
        <CardContent>
          {/* Filters */}
