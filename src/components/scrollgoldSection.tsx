...
const ScrollGoldFeatures = [
  {
    title: "Learn & Earn",
    description: "Earn ScrollGold for completing courses, spiritual check-ins, and kingdom projects",
    icon: Award,
    value: "10-500 SC per activity"
  },
  {
    title: "Blockchain Verified",
    description: "Secure ScrollGold wallet with blockchain credentials and IPFS storage",
    icon: Shield,
    value: "100% Secure"
  },
  {
    title: "Real Value Economy",
    description: "ScrollGold has tangible monetary value for tuition, resources, and services",
    icon: TrendingUp,
    value: "$0.10 - $2.50 per SC"
  },
  {
    title: "Kingdom Rewards",
    description: "Special ScrollGold bonuses for prayer participation and ministry projects",
    icon: Gift,
...
export const ScrollGoldSection = () => {
  return (
    <section id="ScrollGold" className="py-24 px-4 gradient-divine text-primary-foreground">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-lg opacity-90 font-sans max-w-3xl mx-auto">
            ...
            Earn ScrollGold through spiritual formation, academic excellence, and kingdom impact.
          </p>
        </div>

        {/* ScrollGold Wallet Preview */}
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-2xl font-serif font-semibold">Your ScrollGold Wallet</h3>
              </div>
