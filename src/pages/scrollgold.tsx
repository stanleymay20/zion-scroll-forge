...
const spendingOptions = [
  {
    ...
    items: [
      { name: "Extended AI Tutor Sessions", price: "100 ScrollGolds", description: "60 min premium tutoring" },
      { name: "XR Classroom Access", price: "150 ScrollGolds", description: "Virtual reality learning experiences" },
      { name: "Priority Prayer Support", price: "50 ScrollGolds", description: "Fast-track prayer requests" }
    ]
  },
  {
    category: "ScrollBadges & Recognition",
    items: [
      { name: "Custom Profile Badge", price: "200 ScrollGolds", description: "Personalized achievement display" },
      { name: "Faculty Honor Roll", price: "500 ScrollGolds", description: "Featured student recognition" },
      { name: "Mentorship Program Access", price: "300 ScrollGolds", description: "Connect with senior scholars" }
    ]
  },
  {
    category: "Real-World Benefits",
    items: [
      { name: "Course Certification", price: "250 ScrollGolds", description: "Blockchain-verified credentials" },
      { name: "Career Placement Service", price: "400 ScrollGolds", description: "Job matching and placement" },
      { name: "Scholarship Application", price: "100 ScrollGolds", description: "Apply for financial aid" }
    ]
  }
];
...
const ScrollGoldFeatures = [
  ...
  },
  {
    ...
    description: "ScrollGolds have genuine monetary worth and can be converted to real-world benefits",
    icon: TrendingUp
  },
  {
  ...
  },
  {
    ...
    description: "Send ScrollGolds to fellow students for collaboration and support",
    icon: Send
  }
];
...
export default function ScrollGold() {
  return (
    ...
    >
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Earn bonus ScrollGolds</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">+50 bonus ScrollGolds</p>
              </div>
              <div>
                <div className="flex justify-between text-sm mb-2">
                ...
                <p className="text-xs text-muted-foreground mt-1">+100 bonus ScrollGolds</p>
              </div>
              <div>
                <div className="flex justify-between text-sm mb-2">
                ...
                <p className="text-xs text-muted-foreground mt-1">+75 bonus ScrollGolds</p>
              </div>
            </CardContent>
          </Card>
      ...
      <div>
        <h2 className="text-2xl font-semibold mb-4">Ways to Earn ScrollGolds</h2>
